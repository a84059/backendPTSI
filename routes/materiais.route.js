...
module.exports = function(app) {
    ...
    //metais
    app.get('/materiais/metais/all', getController.metais); 
    ...
    //ceramicas
    app.get('/materiais/ceramicas/all', getController.ceramicas); 
    ...
    //moedas
    app.get('/materiais/moedas/all', getController.moedas); 
    ...
    //vidros
    app.get('/materiais/vidros/all', getController.vidros); 
    ...
    //amostras
    app.get('/materiais/amostras/all', getController.amostras); 
    ...
    //elemento_arq
    app.get('/materiais/elemento_arq/all', getController.elemento_arq); 
    ...
    //obj_diverso
    app.get('/materiais/obj_diverso/all', getController.obj_diverso); 
    ...
    //osso
    app.get('/materiais/osso/all', getController.osso); 
    ...
    //rocha
    app.get('/materiais/rocha/all', getController.rocha); 
    ...
    //rocha_motivo
    app.get('/materiais/rocha_motivo/all', getController.rocha_motivo);
    ...
    app.get('/materiais/rocha_painel/material/:id_material', getController.rochaPorMateriaisId);
